# Missing Human Confirmation Spec

Target task_type: generic_document

```yaml document_profile
profile_id: candidate.missing_requires_human_confirmation
profile_version: 0.1.0-candidate
task_type: generic_document
display_name: Generic Document
description: Invalid profile missing requires_human_confirmation.
default_sections:
  - Background
required_sections:
  - background
