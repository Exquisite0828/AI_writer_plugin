...
- 路径：`skills/document-types/<task_type>/steps/step-section-tasks.md`
- 例：`task_type: hara` → `skills/document-types/hara/steps/step-section-tasks.md`，并配合根 skill `skills/document-types/<task_type>/SKILL.md`。
