...
- 例：`task_type: hara` → `skills/document-types/hara/steps/step-template-outline.md`，并配合根 skill `skills/document-types/<task_type>/SKILL.md`。
...
进入 **Step 5 · 研究问题**（产出 `research_questions.json`）。
