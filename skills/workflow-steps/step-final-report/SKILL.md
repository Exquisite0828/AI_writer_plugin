...
- 路径：`skills/document-types/<task_type>/steps/step-final-report.md`
- 例：`task_type: hara` → `skills/document-types/hara/steps/step-final-report.md`，并配合根 skill `skills/document-types/<task_type>/SKILL.md`。
