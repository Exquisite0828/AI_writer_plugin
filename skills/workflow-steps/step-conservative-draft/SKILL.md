...
- 路径：`skills/document-types/<task_type>/steps/step-conservative-draft.md`
- 例：`task_type: hara` → `skills/document-types/hara/steps/step-conservative-draft.md`，并配合根 skill `skills/document-types/<task_type>/SKILL.md`。
